...
const ApplicantProfileViewer = ({
  ...
  // Sync status when selected applicant changes
  useEffect(() => {
    setCurrentStatus(
      selectedApplicant?.status || "Applied"
    );
      ...
      <div className="bg-white rounded-xl shadow-xl max-w-lg w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="p-6">
          ...
          <div className="space-y-4">
            ...
            <button
              type="button"
              className="w-full inline-flex justify-center items-center gap-2 px-4 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition-colors"
              onClick={() =>
                handleDownloadResume(
