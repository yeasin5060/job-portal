    ...
    <div className="min-h-screen bg-gray-50">
      ...
      >
        ...
        <div className="absolute left-4 right-4 bottom-4">
          <button
            className="w-fit flex items-center px-3 py-2.5 text-sm font-medium rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-all duration-200"
            onClick={logout}
          >
